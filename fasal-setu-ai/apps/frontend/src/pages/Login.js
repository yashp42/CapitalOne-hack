...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-primary-950 to-black relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 z-0">
        {/* Gradient overlays */}
        <div className="absolute inset-0 bg-gradient-to-br from-primary-900/20 via-transparent to-secondary-900/30" />
        ...
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-radial from-primary-400/20 to-transparent rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1.2, 1, 1.2],
          ...
          className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-gradient-radial from-secondary-400/15 to-transparent rounded-full blur-3xl"
        />
      </div>
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-8">
        ...
        >
          ...
          >
            <motion.h1 
              className="text-4xl font-bold mb-2 bg-gradient-to-r from-primary-400 to-secondary-400 bg-clip-text text-transparent"
              whileHover={{ scale: 1.02 }}
            >
              Fasal Setu
            </motion.h1>
            <p className="text-gray-400 text-sm">Professional Agricultural Platform</p>
          </motion.div>

          {/* Main Form Card */}
          <motion.div 
            variants={itemVariants}
            className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-700/50 p-8 mb-6"
          >
            {/* Form Header */}
            <div className="text-center mb-6">
              <motion.div
                ...
                className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-primary-500/20 to-secondary-500/20 rounded-2xl flex items-center justify-center"
              >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-20 pr-4 py-4 bg-gray-700/50 border border-gray-600/50 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition-all duration-300"
            ...
            {step === 'phone' && (
              ...
              >
                ...
                <button
                  ...
                  className="text-primary-400 font-semibold mt-1 hover:text-primary-300 transition-colors duration-300"
                >
